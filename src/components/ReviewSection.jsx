...
//       </h1>
//       <div className="text-[#4F5665] font-normal text-base mt-5 text-center w-[550px]">
...
//             <div className={index === 0 ? "ml-28" : ""}>
//               <ReviewCard {...review} key={index} isSelect={index === 0} />
//             </div>
//           ))}
//         </Slider>
//       </div>
...
//             onClick={() => fnPrev()}
//           >
//             <img src={iconleft} alt="arrow-left" className="w-5 h-5" />
//           </div>
//           <div
//             className="flex self-center bg-red-500 rounded-full p-5 cursor-pointer"
//             onClick={() => fnNext()}
//           >
//             <img src={iconright} alt="arrow-right" className="w-5 h-5" />
//           </div>
//         </div>
//       </div>
//     </div>
